...
1. `StanchionRunner.quick()` creates a runner with sensible defaults: in-memory checkpointing, unlimited budget, and standard retry policies.
...
- `StanchionRunner.quick()` gets you running with zero configuration
