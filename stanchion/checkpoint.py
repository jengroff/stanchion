...
class RedisStore:
    ...
    Requires the ``redis`` extra: ``pip install stanchion[redis]``.
    ...
    def __init__(self, redis_url: str, ttl_seconds: int = 3600) -> None:
        try:
            ...
            raise ImportError("redis is required for RedisStore; install with pip install stanchion[redis]") from exc
